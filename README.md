...
<p align="center">
  ...
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/marllonpontes/gostack-desafio-3">
...
```bash
$ git clone https://github.com/marllonpontes/gostack-desafio-3
```

Mova-se para diretório da aplicação:

```bash
$ cd gostack-desafio-3
```
